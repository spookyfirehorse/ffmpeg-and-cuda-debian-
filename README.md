./configure --prefix=/usr \
 ...
 --incdir=/usr/include \
 --extra-cflags="-march=skylake -mtune=skylake -O3 -pipe -ftree-vectorize -mavx2 -mfma -ffast-math -I/usr/include" \
 ...
 --enable-hwaccel=h264_vulkan,hevc_vulkan,vp9_vulkan,av1_vulkan,mpeg1_nvdec,mpeg2_nvdec,mpeg4_nvdec,h264_nvdec,hevc_nvdec,vp8_nvdec,vp9_nvdec,av1_nvdec,vc1_nvdec,wmv3_nvdec,mjpeg_nvdec \
 ...
 --enable-libfreetype --enable-libharfbuzz --enable-libfribidi --enable-ladspa --enable-lv2 \
 --enable-gnutls --enable-gmp --enable-gcrypt --enable-network --enable-alsa --enable-libjack --enable-asm --enable-inline-asm --enable-runtime-cpudetect \
 ...
 --enable-filter=afifo,anull,asplit,aresample,aformat,amix,vulkan,libplacebo,scale,format,fps,crystalizer,bass,treble,equalizer,volume,loudnorm,anequalizer,surround,stereowiden,sidechaincompress,ladspa,lv2,rubberband,crop,overlay,drawtext,boxblur,unsharp,yadif,yadif_cuda,bwdif_cuda,hwupload_cuda,hwdownload,scale_npp,transpose_npp \
 ...
 --enable-decoder=h264,hevc,vp9,av1,ffv1,ffv1_vulkan,prores_vulkan,h264,hevc,vp8,vp9,mjpeg,mpeg1video,mpeg2video,mpeg4,vc1,wmv3,aac,mp3,flac,alac,ape,wavpack,vorbis,dvdsub,pgssub,ass,srt,flv,pcm_s16le,pcm_s24le,pcm_s32le,pcm_f32le,pcm_f64le,dsd_lsbf,dsd_msbf \
 --enable-encoder=h264_vulkan,hevc_vulkan,av1_vulkan,ffv1,ffv1_vulkan,h264_nvenc,hevc_nvenc,av1_nvenc,aac,libmp3lame,libopus,flac,alac,pcm_s16le,pcm_s24le,pcm_s32le,pcm_f32le \
